  ...
  <BaseIcon size={size} viewBox={active ? '16 52 20 20' : '16 16 20 20'} className={className}>
    {active ? (
      <>
        ...
        <path d="M18.5 62H33.5004" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      </>
    ) : (
      <>
        <path d="M22.6667 18.5H20.1667C19.7246 18.5 19.3007 18.6756 18.9882 18.9882C18.6756 19.3007 18.5 19.7246 18.5 20.1667V22.6667M33.5 22.6667V20.1667C33.5 19.7246 33.3244 19.3007 33.0118 18.9882C32.6993 18.6756 32.2754 18.5 31.8333 18.5H29.3333M29.3333 33.5H31.8333C32.2754 33.5 32.6993 33.3244 33.0118 33.0118C33.3244 32.6993 33.5 32.2754 33.5 31.8333V29.3333M18.5 29.3333V31.8333C18.5 32.2754 18.6756 32.6993 18.9882 33.0118C19.3007 33.3244 19.7246 33.5 20.1667 33.5H22.6667" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
