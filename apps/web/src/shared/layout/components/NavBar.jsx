  ...
  return (
    <div className="absolute bottom-0 right-0 pb-3xl pr-base flex flex-col gap-m items-center z-20">
      ...
      <div className="w-17 flex flex-col">
        <button onClick={() => go('/connections')} className="w-full h-17 bg-yrgo-red rounded-t-full flex items-center justify-center cursor-pointer">
          <HeartIcon active={pathname === '/connections'} size={20} className="text-white" />
        </button>
        <button onClick={() => go('/users')} className="w-full aspect-square bg-yrgo-red flex items-center justify-center cursor-pointer">
          <SearchIcon active={pathname === '/users'} size={20} className="text-white" />
        </button>
        <button onClick={() => go('/palette')} className="w-full aspect-square bg-yrgo-red rounded-b-full flex items-center justify-center cursor-pointer">
